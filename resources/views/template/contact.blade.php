    ...
    @include('layouts.navbar')
        ...
        <div class="container-xxl py-5 bg-dark hero-header mb-5">
            <div class="container text-center my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Contact Nous</h1>
        ...
        <div class="row g-4">
            <div class="col-12">
                <div class="row gy-4">
                    ...
                    <div class="col-md-4">
                        <h5 class="section-title ff-secondary fw-normal text-start text-primary">Problème Technique</h5>
